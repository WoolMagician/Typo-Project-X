...
public class RuntimeAnchorBase<T> : DescriptionBaseSO where T : UnityEngine.Object
{
    ...
    [Header("Debug")]
    [ShowOnly] public bool isSet = false; // Any script can check if the transform is null before using it, by just checking this bool

    [ShowOnly] [SerializeField] private T _value;
    public T Value
    {
        get { return _value; }
    }
