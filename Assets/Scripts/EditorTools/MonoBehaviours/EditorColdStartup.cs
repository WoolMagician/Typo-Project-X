...
public class EditorColdStartup : MonoBehaviour
{
    ...
    [Header("Broadcast on")]
    [SerializeField] private VoidEventChannelSO _sceneReadyChannel = default;
	...
	{
		_coldStartupChannel.LoadAssetAsync<LoadEventChannelSO>().Completed += OnNotifyChannelLoaded;
	}
